...
# Go
go get github.com/arcp-io/go-sdk

# Rust
cargo add arcp

# Java / Kotlin (Maven)
# <dependency><groupId>io.arcp</groupId><artifactId>arcp-sdk</artifactId>...
```
...
Open a session, invoke a tool, print the result.

```typescript
import { connect } from "@arcp/sdk";

const session = await connect("wss://runtime.example/arcp", {
  auth: { scheme: "bearer", token: process.env.ARCP_TOKEN! },
  client: { kind: "demo", version: "0.1.0" },
...
```text
{ result_ref: { artifact_id: "art_01JABC", uri: "arcp://...", media_type: "application/json", size: 92413, sha256: "..." } }
```
...
| --------------------------- | ---------- | ------------ | --------- |
| `@arcp/sdk`                 | TypeScript | ARCP project | Reference |
| `arcp` (PyPI)               | Python     | ARCP project | Reference |
| `github.com/arcp-io/go-sdk` | Go         | ARCP project | Reference |
| `arcp` (crates.io)          | Rust       | ARCP project | Reference |
| `io.arcp:arcp-sdk`          | Java       | ARCP project | Reference |
| `io.arcp:arcp-sdk-kotlin`   | Kotlin     | ARCP project | Reference |
| `Arcp` (SwiftPM)            | Swift      | ARCP project | Reference |
| `arcp` (RubyGems)           | Ruby       | ARCP project | Reference |
| `arcp/sdk` (Packagist)      | PHP        | ARCP project | Reference |
| `Arcp.Sdk` (NuGet)          | C#         | ARCP project | Reference |
| `Arcp.Sdk.FSharp` (NuGet)   | F#         | ARCP project | Reference |
